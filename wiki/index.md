...
- [[macd]] — MACD（トレンドフォロー型テクニカル指標）
- [[rsi]] — RSI（モメンタム型テクニカル指標）
- [[swing-trade]] — スウィングトレード（中期トレード手法）
- [[divergence]] — ダイバージェンス（価格と指標の乖離現象）
- [[bollinger-band]] — ボリンジャーバンド（ボラティリティ指標）
- [[atr]] — ATR（価格変動幅の平均）
- [[risk-management]] — リスク管理（損失制限・資金保全）
- [[backtesting]] — バックテスト（過去データによる戦略検証）
